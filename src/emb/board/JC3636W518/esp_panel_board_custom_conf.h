...
// To increase the upper limit of the PCLK, see:
...
#define ESP_PANEL_BOARD_LCD_RGB_PCLK_ACTIVE_NEG \
    (0)  // 0: rising edge, 1: falling edge. Typically set to 0
         // The following sheet shows the valid combinations of
         // data width and pixel bits:
         // ┏---------------------------------┳- -------------------------------┓
#define ESP_PANEL_BOARD_LCD_RGB_DATA_WIDTH \
    (16)  // |                16               |               8                 |
#define ESP_PANEL_BOARD_LCD_RGB_PIXEL_BITS \
    (ESP_PANEL_LCD_COLOR_BITS_RGB565)  // | ESP_PANEL_LCD_COLOR_BITS_RGB565 | ESP_PANEL_LCD_COLOR_BITS_RGB888 |
                                       // ┗---------------------------------┻---------------------------------┛
...
#define ESP_PANEL_BOARD_LCD_RGB_IO_DATA15 \
    (1)  //                       |   R4   |  R5    |   R7   |
         //                       ┗--------┻--------┻--------┛
...
#define ESP_PANEL_BOARD_LCD_MIPI_DSI_LANE_RATE_MBPS \
    (1000)  // Single lane bit rate, should check the LCD drive IC
 ...
 *
 * Set to 1 if the `mirror()` function will be implemented by LCD command. Otherwise, the function will be implemented
 * by software. Only valid when `ESP_PANEL_BOARD_LCD_FLAGS_ENABLE_IO_MULTIPLEX` is 0.
 */
...
#endif
/* For panel */
#define ESP_PANEL_BOARD_TOUCH_I2C_ADDRESS \
...
/* For device */
#define ESP_PANEL_BOARD_EXPANDER_I2C_ADDRESS \
