 ...
 *
 *  -BOARD_ESPRESSIF_ESP32_C3_LCDKIT (ESP32-C3-LCDkit):
 * https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c3/esp32-c3-lcdkit/index.html
 ...
 *  -BOARD_ESPRESSIF_ESP32_S3_BOX_3_BETA (ESP32-S3-Box-3(beta)):
 * https://github.com/espressif/esp-box/tree/c4c954888e11250423f083df0067d99e22d59fbe -BOARD_ESPRESSIF_ESP32_S3_BOX_LITE
 * (ESP32-S3-Box-Lite): https://github.com/espressif/esp-box/tree/master -BOARD_ESPRESSIF_ESP32_S3_EYE (ESP32-S3-EYE):
 * https://github.com/espressif/esp-who/blob/master/docs/en/get-started/ESP32-S3-EYE_Getting_Started_Guide.md
 *  -BOARD_ESPRESSIF_ESP32_S3_KORVO_2 (ESP32-S3-Korvo-2):
 * https://docs.espressif.com/projects/esp-adf/en/latest/design-guide/dev-boards/user-guide-esp32-s3-korvo-2.html
 *  -BOARD_ESPRESSIF_ESP32_S3_LCD_EV_BOARD (ESP32-S3-LCD-EV-Board(v1.1-v1.4)):
 * https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-lcd-ev-board/user_guide_v1.4.html
 *  -BOARD_ESPRESSIF_ESP32_S3_LCD_EV_BOARD_V1_5 (ESP32-S3-LCD-EV-Board(v1.5)):
 * https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-lcd-ev-board/user_guide.html
 *  -BOARD_ESPRESSIF_ESP32_S3_LCD_EV_BOARD_2 (ESP32-S3-LCD-EV-Board-2(v1.1-v1.4))):
 * https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-lcd-ev-board/user_guide_v1.4.html
 *  -BOARD_ESPRESSIF_ESP32_S3_LCD_EV_BOARD_2_V1_5 (ESP32-S3-LCD-EV-Board-2(v1.5)):
 * https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-lcd-ev-board/user_guide.html
 *  -BOARD_ESPRESSIF_ESP32_S3_USB_OTG (ESP32-S3-USB-OTG):
 * https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-usb-otg/index.html
 *  -BOARD_ESPRESSIF_ESP32_P4_FUNCTION_EV_BOARD (ESP32-P4-Function-EV-Board):
 ...
 *
 *  -BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_1_85 (ESP32_S3_Touch_LCD_1_85):
 * https://www.waveshare.com/esp32-s3-touch-lcd-1.85.htm -BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_1_85_C
 * (ESP32_S3_Touch_LCD_1_85_C): https://www.waveshare.com/esp32-s3-touch-lcd-1.85c.htm
 *  -BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_2_1 (ESP32_S3_Touch_LCD_2_1):
 * https://www.waveshare.com/esp32-s3-touch-lcd-2.1.htm -BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_4_3
 * (ESP32_S3_Touch_LCD_4_3): https://www.waveshare.com/esp32-s3-touch-lcd-4.3.htm
 *  -BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_4_3_B (ESP32_S3_Touch_LCD_4_3_B):
 * https://www.waveshare.com/esp32-s3-touch-lcd-4.3B.htm -BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_5 (ESP32_S3_Touch_LCD_5):
 * https://www.waveshare.com/esp32-s3-touch-lcd-5.htm?sku=28117 -BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_5_B
 * (ESP32_S3_Touch_LCD_5_B): https://www.waveshare.com/esp32-s3-touch-lcd-5.htm?sku=28151
 ...
 *  - BOARD_VIEWE_UEDX24240013_MD50E (UEDX24240013-MD50E):
 * https://github.com/VIEWESMART/UEDX24240013-MD50ESP32_1.3inch-Knob
 *  - BOARD_VIEWE_UEDX24320024E_WB_A (UEDX24320024E-WB-A):
 * https://viewedisplay.com/product/esp32-2-4-inch-240x320-rgb-ips-tft-display-touch-screen-arduino-lvgl-wifi-ble-uart-smart-module/
 *  - BOARD_VIEWE_UEDX24320028E_WB_A (UEDX24320028E-WB-A):
 ...
 *  - BOARD_VIEWE_UEDX24320035E_WB_A (UEDX24320035E-WB-A):
 * https://viewedisplay.com/product/esp32-3-5-inch-240x320-mcu-ips-tft-display-touch-screen-arduino-lvgl-wifi-ble-uart-smart-module/
 *  - BOARD_VIEWE_UEDX32480035E_WB_A (UEDX32480035E-WB-A):
 * https://github.com/VIEWESMART/Product-Specification-and-Schematic/blob/main/ESP32/3.5inch/320480/UEDX32480035E-WB-A%20SPEC.pdf
 *  - BOARD_VIEWE_UEDX46460015_MD50ET (UEDX46460015-MD50ET):
 * https://github.com/VIEWESMART/UEDX46460015-MD50ESP32-1.5inch-Touch-Knob-Display
 *  - BOARD_VIEWE_UEDX48270043E_WB_A (UEDX48270043E-WB-A):
 * https://github.com/VIEWESMART/Product-Specification-and-Schematic/blob/main/ESP32/4.3inch/Low-Resolution_480272/UEDX48270043E-WB-A%20SPEC.pdf
 *  - BOARD_VIEWE_UEDX48480021_MD80E_V2 (UEDX48480021-MD80E(T)):
 * https://github.com/VIEWESMART/UEDX48480021-MD80ESP32_2.1inch-Knob
 *  - BOARD_VIEWE_UEDX48480021_MD80E (UEDX48480021-MD80E):
 * https://github.com/VIEWESMART/UEDX48480021-MD80ESP32_2.1inch-Knob
 *  - BOARD_VIEWE_UEDX48480021_MD80ET (UEDX48480021-MD80ET):
 * https://github.com/VIEWESMART/UEDX48480021-MD80ESP32-2.1inch-Touch-Knob-Display
 *  - BOARD_VIEWE_UEDX48480040E_WB_A (UEDX48480040E-WB-A):
 * https://viewedisplay.com/product/esp32-4-inch-tft-display-touch-screen-arduino-lvgl/
 *  - BOARD_VIEWE_UEDX80480043E_WB_A (UEDX80480043E-WB-A):
 * https://viewedisplay.com/product/esp32-4-3-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl/
 *  - BOARD_VIEWE_UEDX80480050E_AC_A (UEDX80480050E-AC-A):
 * https://viewedisplay.com/product/esp32-5-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl/
 *  - BOARD_VIEWE_UEDX80480050E_WB_A (UEDX80480050E-WB-A):
 * https://viewedisplay.com/product/esp32-5-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl/
 *  - BOARD_VIEWE_UEDX80480050E_WB_A_2 (UEDX80480050E-WB-A):
 * https://viewedisplay.com/product/esp32-5-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl/
 *  - BOARD_VIEWE_UEDX80480070E_WB_A (UEDX80480070E-WB-A):
 * https://viewedisplay.com/product/esp32-7-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl-uart/
 */
